...
This repository contains exercises from the **AI (Artificial Intelligence)** class, covering topics such as LLM, DNN, Machine Learning, data analytics, Agents, and more.

Further theory explanations can be found [in this Notion page](https://kaiane.notion.site/Artificial-Intelligence-274c701cca24800385c6c9aaf657dcc7?source=copy_link).
